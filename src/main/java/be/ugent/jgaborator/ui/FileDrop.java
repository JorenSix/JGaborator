 ...
 * system to a Java program. Any {@code java.awt.Component} can be
 * dropped onto, but only {@code javax.swing.JComponent}s will indicate
 * the drop event with a changed border.
 * 
 * To use this class, construct a new {@code FileDrop} by passing
 * it the target component and a {@code Listener} to receive notification
...
public class FileDrop
{
     ...
     * If your component is a {@code java.awt.Container}, then each of its children
     ...
     *
     * @param c Component on which files will be dropped.
     * @param dragBorder Border to use on {@code JComponent} when dragging occurs.
     * @param listener Listens for {@code filesDropped}.
     * @since 1.0
     */
    public FileDrop(
